export const emailTemplates = Object.freeze({
  ...
  // Dynamic data includes: receiverName, receiverEmail, passwordResetUrl, subject: 'Welcome To Moun Club', dynamicTemplateDate: {
  ...
  // Dynamic data includes: subject, password, passwordResetUrl: 'Referral acceptance', dynamicTemplateDate: {
    //receiverName: receiverName,
