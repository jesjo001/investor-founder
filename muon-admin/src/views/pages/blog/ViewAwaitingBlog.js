...
import { postApproveBlog, getUnapprovedBlogs } from '../../../store/actions/blogActions';
...
function ViewBlog(props) {
  ...
  const fetchAllBlogs = async () => {
    setLoading(true);
    try {
      await dispatch(getUnapprovedBlogs());
      setLoading(false);
    } catch (error) {
  ...
  const handleApproveBlog = async () => {
    ...
    try {
      ...
      props.history.push('/blogs/awaiting-approval');
